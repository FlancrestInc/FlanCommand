...
export const redactSafeText = (value: string): string =>
  value
...
export function redactSafeValue(value: unknown, key?: string): unknown {
...
export const agentEventSchema = z.discriminatedUnion("type", [
  ...
  z
    .object({
      ...
      raw: z
        .record(z.unknown())
        .transform((raw) => redactSafeValue(raw) as Record<string, unknown>),
    })
    .strict(),
]);
